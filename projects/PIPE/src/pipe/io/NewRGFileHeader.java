...
/**
 * Version of RGFileHeadr implemented using the faster java.nio.* classes
 * 
...
public class NewRGFileHeader extends RGFileHeader {
	 ...
	 * @throws IncorrectFileFormatException
	 */
	public void read(MappedByteBuffer inputBuf) throws IOException, IncorrectFileFormatException{
