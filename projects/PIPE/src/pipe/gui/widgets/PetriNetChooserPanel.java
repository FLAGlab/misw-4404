 ...
 * which is a JPanel containing the required stuff
 * @author Maxim 
 */
public class PetriNetChooserPanel extends JPanel {
  ...
  public PetriNetChooserPanel(String title,DataLayer defaultNet) {
    super();
...
//    textField.setPreferredSize(new Dimension());
  ...
  private ActionListener browseButtonClick=new ActionListener() {
    public void actionPerformed(ActionEvent e) {
      ...
      if(f!=null)textField.setText(f.getAbsolutePath());
    }
  };
  
  public DataLayer getDataLayer() {
    if ((useCurrent!=null)&&(useCurrent.isSelected())) return defaultNet;
    else {
