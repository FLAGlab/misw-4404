...
//######################################################################################
	public static Object loadExtClass(URL classURL)
	{
		Object myObj = null;
		try
		{
//			System.err.println(classURL.getFile());
			myObj = classURL.getContent();
		}
		catch (Exception e)
		{
			System.err.println("loadExtClass caused an IO Exception");
		}
		return myObj;
	}
//######################################################################################
...
//######################################################################################
	public void addClassRootToPath(Class someClass)
	{
		File rootPath = getClassRoot(someClass);
		if (rootPath != null) {
