...
public class EnterOptionsPane extends JPanel {
	//Components in panel
	private JTextField startStatesField, targetStatesField, stepField, TStopField, TStartField, bufferField;
	private JLabel startStLbl, targetStLbl, stepLbl, TStopLbl, TStartLbl, bufferLbl;
	...
	public EnterOptionsPane(boolean defaultStatus) {
		...
		calcRTbox = new JCheckBox("Calculate Response Time PDF");
		c.weightx = 0.5;
		c.gridx = 0;
		c.gridy = 3;
		c.gridwidth = 3;
		...
		calcCDFbox = new JCheckBox("Calculate Response Time CDF");
		c.weightx = 0.5;
		c.gridx = 0;
		c.gridy = 4;
		c.gridwidth = 3;
		...
		// Uncomment to allow distributed Map Reduce calculation
...
//		this.add(hadpne, c);
	...
	/**
	 * Associated panel that contains input options related to selecting whether the
	 * analysis should be run locally or as a MapReduce job
	 * 
