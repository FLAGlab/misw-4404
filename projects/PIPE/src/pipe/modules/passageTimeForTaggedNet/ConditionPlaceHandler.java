...
public class ConditionPlaceHandler extends MouseAdapter
{
	...
	DataLayer currentPNML;
	
	public ConditionPlaceHandler(JDialog parentDialog, ConditionPlace place, DataLayer data)
	{
		parent = parentDialog;
		this.place = place;
		this.currentPNML = data;
	}
...
//					 operatorStr= "==";
					 ...
					 Integer targetStrInt=new Integer(currentPNML.getPlaceIndex(placeStr));
